                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="widget widget-text mg-footer-mbb">
                            <div class="content">
                                ...
                                <p>
                                    We redefine legal excellence, providing tailored solutions for your unique
                                    needs. Trust us for unwavering dedication and success in every legal endeavor.
                                </p>
                    ...
                    <div class="row col-lg-6 justify-content-end">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="widget widget-contact mg-footer-mbb">
                                ...
                                <div class="content">
                                    <ul>
                                        <li><span class="text address">123 Main Street, Karachi, Pakistan</span>
                                        </li>
                        ...
                        <div class="bottom-wrap">
                            <div class="row">
                                <div class="col-lg-5 col-md-12">
                                    <div class="copyright">
                                        <a href="templateshub.net">Copyright © 2024 Suprimo - All Rights
                                            Reserved.</a>
                                    </div>
                                </div>
