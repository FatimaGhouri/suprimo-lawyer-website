        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="content">
                    ...
                    <p> Our specialized attorneys bring unparalleled expertise, commitment, and success to every client and case
                    </p>
                </div>
            </div>
            <div class="col-lg-6">
...
<div class="attorneys attorneys-style1">
    <div class="container">
        <div class="title-section text-center">
            ...
            <p class="sub-title">Expert attorneys, unparalleled excellence</p>
        </div>
        ...
        <div class="row searchRow">
            <div class="col-lg-12" id="serviceSearchDiv">
